...
public class RSAUtil {
	...
	public static void main(String[] args) throws Exception {
		String str = null;
		try {
			str = RSAUtil.encrypt("123456");
		} catch (Exception e) {
			e.printStackTrace();
		}
		System.out.println(str);
		String decrypt = RSAUtil.decrypt(
				"AyjEPh4hHi+iB3fnOw9XBZrWI/gyKJ6RXoXtBiReSiN0OtK2UIZu1EvE7vUaEnzdS53cCHZApW9HM9fAv2aiLsqka15fKZPXe7hSFlhwQbP50VWL7W1EKY3Y43wYNz5xhD50CBZQ8eXoUfDdLrch5paKTz0ITZDm/wt/ULVQHzg="
		);
